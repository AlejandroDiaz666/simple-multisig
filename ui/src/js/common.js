...
const common = module.exports = {
	...
	if (false && window.ethereum) {
	    ...
	    console.log('checkForMetaMask: modern dapp browser');
		...
		common.web3 = null;
	        console.log('checkForMetaMask: (user denied?) err = ' + error.toString());
		cb('You must enable the MetaMask plugin to use this utility', null);
	    }
	} else if (typeof window.web3 !== 'undefined') {
	    // Legacy dapp browsers...
	    console.log('checkForMetaMask: legacy dapp browser');
	    common.web3 = new Web3(web3.currentProvider);
	    console.log('checkForMetaMask: provider: ' + web3.currentProvider.toString());
	    web3.version.getNetwork((err, netId) => {
		console.log('checkForMetaMask: netId = ' + netId);
		if (!!err)
		    cb(err, null)
	    ...
	    common.web3 = null;
	    console.log('checkForMetaMask: no metamask at all');
	    cb('You must enable the MetaMask plugin to use this utility', null);
	}
    },
	...
	if (!button)
	    console.log('setMenuButtonState: could not find elem: ' + buttonId);
	...
	console.log('setMenuButtonState: ' + buttonId + ' class = ' + button.className);
    },
