...
const smsUtil = module.exports = {
    ...
    help:
    '<br/>' +
	'<h1>How to Use the Simple MultiSig Wallet</h1><br/>' +
	'<p>' +
	...
	'<p>' +
	'Since the threshold for this wallet is set to one, I have the ability to execute the transaction immediately after signing it. If I had needed to collect more signatures I would have copied the JSON text, which includes my signature; and I would have sent it to my friend, Rasputen; Rasputen would have loaded the transaction from the JSON text, signed it, and he would have sent the new JSON text back to me.</p>' +
	'<p>' +
	'The last step is to click the button that says &quot;Execute this transaction&quot; to send the transaction to the contract for execution.<br/>' +
